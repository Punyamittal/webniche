    ...
    <div className="showcase-page">
      <section className="showcase-hero">
        <div className="relative w-screen h-screen overflow-hidden">
          ...
          <div className="absolute inset-0 z-10 pt-48 md:pt-64 lg:pt-72 xl:pt-80 px-4 md:px-8 pointer-events-none">
            <motion.div
              className="text-center text-white w-full max-w-2xl mx-auto showcase-hero-text"
              initial={{ opacity: 0, y: 30 }}
              animate={{ opacity: 1, y: 0 }}
              transition={{ duration: 0.8 }}
            >
              <h1 className="text-3xl md:text-4xl lg:text-5xl xl:text-6xl font-bold mb-6 showcase-hero-title">
                Our <span className="highlight">Work</span>
              </h1>
              <p className="text-lg md:text-xl lg:text-2xl xl:text-2xl text-white showcase-hero-description">
