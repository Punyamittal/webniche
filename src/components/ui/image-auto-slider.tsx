...
export const ImageAutoSlider: React.FC<ImageAutoSliderProps> = ({
  ...
  return (
    <>
      ...
      <div className={`w-full bg-transparent relative overflow-hidden flex items-center justify-center py-8 ${className}`}>
        {/* Scrolling images container */}
        <div className="relative z-10 w-full flex items-center justify-center">
          <div className="scroll-container w-full max-w-6xl">
            <div className={`${direction === 'left' ? 'infinite-scroll-left' : 'infinite-scroll-right'} flex gap-6 w-max`}>
